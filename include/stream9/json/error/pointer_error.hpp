#ifndef STREAM9_JSON_ERROR_POINTER_ERROR_HPP
#define STREAM9_JSON_ERROR_POINTER_ERROR_HPP
...
template<>
struct is_error_condition_enum<stream9::json::pointer_errc> : public true_type {};

} // namespace std

#endif // STREAM9_JSON_ERROR_POINTER_ERROR_HPP
